...
public class AppContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        // Copy students.txt and registrations.txt from resources to data/ directory
        copyResourceToData("students.txt");
        copyResourceToData("registrations.txt");
        copyResourceToData("courses.txt");
