...
<body class="bg-gray-100" style="background-image: url('${pageContext.request.contextPath}/images/background.jpg'); background-size: cover; background-attachment: fixed;">
    ...
    <div class="max-w-4xl mx-auto mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="student?action=submitFeedback" class="bg-purple-500 text-white p-4 rounded-lg hover:bg-purple-600 flex items-center justify-center">
                <i class="fas fa-comment mr-2"></i> Student Feedback
            </a>
        </div>
    </div>
</body>
